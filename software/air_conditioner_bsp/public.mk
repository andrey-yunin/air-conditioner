...
SOPCINFO_FILE := $(ABS_BSP_ROOT_DIR)/../../embedded_computer_system.sopcinfo
...
# Design Name 
# setting SOPC_NAME is embedded_computer_system
SOPC_NAME := embedded_computer_system
...
# setting SOPC_SYSID_BASE_ADDRESS is 0x8081768
SOPC_SYSID_FLAG += --sidp=0x8081768
ELF_PATCH_FLAG  += --sidp 0x8081768

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1653660855
SOPC_SYSID_FLAG += --timestamp=1653660855
ELF_PATCH_FLAG  += --timestamp 1653660855
