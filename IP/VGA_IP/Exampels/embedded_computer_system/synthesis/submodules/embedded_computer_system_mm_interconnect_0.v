...
module embedded_computer_system_mm_interconnect_0 (
	...
	wire  [19:0] vga_ip_0_avalon_slave_0_agent_m0_address;                                  // VGA_IP_0_avalon_slave_0_agent:m0_address -> VGA_IP_0_avalon_slave_0_translator:uav_address
	...
	wire  [94:0] vga_ip_0_avalon_slave_0_agent_rf_source_data;                              // VGA_IP_0_avalon_slave_0_agent:rf_source_data -> VGA_IP_0_avalon_slave_0_agent_rsp_fifo:in_data
	...
	wire  [94:0] vga_ip_0_avalon_slave_0_agent_rsp_fifo_out_data;                           // VGA_IP_0_avalon_slave_0_agent_rsp_fifo:out_data -> VGA_IP_0_avalon_slave_0_agent:rf_sink_data
	...
	wire  [93:0] cmd_mux_001_src_data;                                                      // cmd_mux_001:src_data -> VGA_IP_0_avalon_slave_0_agent:cp_data
	wire         cmd_mux_001_src_ready;                                                     // VGA_IP_0_avalon_slave_0_agent:cp_ready -> cmd_mux_001:src_ready
	wire   [3:0] cmd_mux_001_src_channel;                                                   // cmd_mux_001:src_channel -> VGA_IP_0_avalon_slave_0_agent:cp_channel
	...
	wire   [3:0] cmd_mux_002_src_channel;                                                   // cmd_mux_002:src_channel -> cpu_debug_mem_slave_agent:cp_channel
	...
	wire  [19:0] onchip_ram_s1_agent_m0_address;                                            // onchip_ram_s1_agent:m0_address -> onchip_ram_s1_translator:uav_address
	...
	wire  [93:0] cmd_mux_003_src_data;                                                      // cmd_mux_003:src_data -> onchip_ram_s1_agent:cp_data
	wire         cmd_mux_003_src_ready;                                                     // onchip_ram_s1_agent:cp_ready -> cmd_mux_003:src_ready
	wire   [3:0] cmd_mux_003_src_channel;                                                   // cmd_mux_003:src_channel -> onchip_ram_s1_agent:cp_channel
	...
	wire  [93:0] vga_ip_0_avalon_slave_0_agent_rp_data;                                     // VGA_IP_0_avalon_slave_0_agent:rp_data -> router_003:sink_data
	...
	wire  [93:0] onchip_ram_s1_agent_rp_data;                                               // onchip_ram_s1_agent:rp_data -> router_005:sink_data
	...
	wire  [93:0] cmd_demux_001_src2_data;                                                   // cmd_demux_001:src2_data -> cmd_mux_003:sink1_data
	...
	wire  [93:0] rsp_demux_003_src1_data;                                                   // rsp_demux_003:src1_data -> rsp_mux_001:sink2_data
	...
	embedded_computer_system_mm_interconnect_0_router_003 router_003 (
	...
	embedded_computer_system_mm_interconnect_0_cmd_mux_001 cmd_mux_001 (
		.clk                 (clk_0_clk_clk),                         //       clk.clk
		.reset               (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	embedded_computer_system_mm_interconnect_0_rsp_demux_001 rsp_demux_001 (
		.clk                (clk_0_clk_clk),                         //       clk.clk
		.reset              (cpu_reset_reset_bridge_in_reset_reset), // clk_reset.reset
