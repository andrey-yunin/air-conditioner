...
//   output_name:       tb_average_value_component_dpi_controller_slave_done_concatenate_inst
//   multibit_width:    2
//
// ------------------------------------------

module tb_average_value_component_dpi_controller_slave_done_concatenate_inst
#(
