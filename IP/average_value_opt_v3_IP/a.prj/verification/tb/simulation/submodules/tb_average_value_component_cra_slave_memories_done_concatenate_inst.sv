...
//   output_name:       tb_average_value_component_cra_slave_memories_done_concatenate_inst
//   multibit_width:    1
//
// ------------------------------------------

module tb_average_value_component_cra_slave_memories_done_concatenate_inst
#(
